    ...
    const response = await axiosInstance.get<IResponseBody<IPage<TClientBody>>>(
        CLIENT_LIST,
        {
            params: {
                ...
                cep: clientPageable?.cep,
                addres: clientPageable?.address,
                city: clientPageable?.city,
                neighborhood: clientPageable?.neighborhood,
                uf: clientPageable?.uf,
                createDate: clientPageable?.createDate,
