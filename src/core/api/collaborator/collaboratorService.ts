    ...
    const response = await axiosInstance.get<IResponseBody<IPage<TCollaboratorBody>>>(
        COLLABORATOR_LIST,
        {
            params: {
                ...
                cep: collaboratorPageable?.cep,
                addres: collaboratorPageable?.address,
                city: collaboratorPageable?.city,
                neighborhood: collaboratorPageable?.neighborhood,
                uf: collaboratorPageable?.uf,
            }
        }
    );
