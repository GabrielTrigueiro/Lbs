...
const head: ITableHeadCell[] = [
    ...
    { name: "birthDate", label: "Data de nascimento", align: "left" },
...
const filterItems: ISelectItem[] = [
    ...
    { name: "Endereço", value: "address", type: "texto" },
    ...
    const { data, isLoading, isSuccess } = useQuery({
        ...
        queryFn: () =>
            fecthCollaborator(
                ...
                collaboratorFilters.cep,
                collaboratorFilters.address,
                collaboratorFilters.city,
                collaboratorFilters.neighborhood,
                collaboratorFilters.uf,
            ),
        staleTime: Infinity,
    })
