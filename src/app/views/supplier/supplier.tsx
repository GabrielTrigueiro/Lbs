...
const head: ITableHeadCell[] = [
    ...
    { name: "uf", label: "Estado", align: "left" },
    { name: "cep", label: "CEP", align: "left" },
    { name: "city", label: "Cidade", align: "left" },
    { name: "neighborhood", label: "Bairro", align: "left" },
...
const items: ISelectItem[] = [
    ...
    { name: "CNPJ", value: "cpforCnpj", type: "texto" },
    { name: "CEP", value: "cep", type: "texto" },
    { name: "Cidade", value: "city", type: "texto" },
    { name: "Data de criação", value: "createDate", type: "date" },
    { name: "Bairro", value: "neighborhood", type: "texto" },
    { name: "UF", value: "uf", type: "texto" },
];
    ...
    const { data, isLoading, isSuccess } = useQuery({
        ...
        queryFn: () =>
            fecthSupplier(
                ...
                orderBy,
                order,
                supplierFilters.name,
                supplierFilters.cep,
                supplierFilters.address,
                supplierFilters.city,
                supplierFilters.neighborhood,
                supplierFilters.uf,
                supplierFilters.createDate,
