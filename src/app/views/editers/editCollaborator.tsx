import { TCollaboratorBody, TCollaboratorRegister, TCollaboratorUpdate } from "core/models/collaborator";
...
import { deepEqual, formatCEP, formatarCEP, removeNonNumeric, statesOpitions } from "core/utils/globalFunctions";
